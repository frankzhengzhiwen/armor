...
import armor.web.extension.spi.PropertyBootstrapBinder;
import armor.web.extension.spi.PropertyBootstrapLoader;
...
//	}
	...
	public void initialize(ConfigurableApplicationContext applicationContext) {
		List<PropertyBootstrapBinder> propertyootstrapBinders
					= ArmorExtensionLoader.getInstance(PropertyBootstrapBinder.class).get();
		List<PropertyBootstrapLoader> propertyBootstrapLoaders
					= ArmorExtensionLoader.getInstance(PropertyBootstrapLoader.class).get();
