...
//								BeanPostProcessor
	...
	private static final String ARMOR_AUTOWIRE_DIRECTORY = "META-INF/armor/beans/";
...
//	private Set<String> cachedNames = new HashSet<>();
	...
	public void afterPropertiesSet() throws Exception {
            ...
            if (classLoader != null) {
                urls = classLoader.getResources(ARMOR_AUTOWIRE_DIRECTORY);
            } else {
                urls = ClassLoader.getSystemResources(ARMOR_AUTOWIRE_DIRECTORY);
            }
            if (urls != null) {
